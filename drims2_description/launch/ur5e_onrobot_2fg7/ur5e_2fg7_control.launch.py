...
def launch_setup(context, *args, **kwargs):
    ...
    # Reemplaza el spawner del controlador Robotiq por el del OnRobot
    onrobot_fake_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
    ...
    what_to_launch = [
        ...
        onrobot_fake_controller_spawner,
        onrobot_driver_launch
    ]
