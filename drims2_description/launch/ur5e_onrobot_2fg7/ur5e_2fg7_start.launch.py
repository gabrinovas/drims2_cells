...
def launch_setup(context):
  launch_moveit_path = PathJoinSubstitution([FindPackageShare('drims2_description'), 'launch', 'ur5e_onrobot_2fg7', 'ur5e_2fg7_moveit.launch.py'])
  ...
  launch_controllers_path = PathJoinSubstitution([FindPackageShare('drims2_description'), 'launch', 'ur5e_onrobot_2fg7', 'ur5e_2fg7_control.launch.py'])
  ...
  motion_server_path = PathJoinSubstitution([FindPackageShare("drims2_description"), "launch", "ur5e_onrobot_2fg7", "ur5e_2fg7_motion_server.launch.py"])
